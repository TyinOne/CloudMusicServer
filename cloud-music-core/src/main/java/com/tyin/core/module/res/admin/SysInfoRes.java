...
public class SysInfoRes {
    ...
    private JvmRes jvm;
    private SysRes sys;
    private List<DiskRes> disks;

    @Setter
    public static class CpuRes {
        /**
         * 核心数
         */
        @Getter
