...
@Aspect
public class AdminRequestLogAop implements Ordered {
    ...
    public Object requestLog(ProceedingJoinPoint joinPoint) throws ApiException {
        ...
        AdminRequestLog.AdminRequestLogBuilder builder = AdminRequestLog.builder();
    ...
    private void builder(AdminRequestLog.AdminRequestLogBuilder builder, long start, String resultStr, long end) {
        long elapsed;
        elapsed = end - start;
        ...
        log.info("=====================================Method  End====================================");
        AdminRequestLog requestLog = builder.build();
